...
if (isset($_POST['email']) && isset($_POST['passwd'])) {
  ...
  if ($_POST['email'] == 'myemail@google.com' &&
    md5($_POST['passwd']) == md5('123')) {
...
<h1 class="label label-danger" style="font-size: 1.5em; line-height: 2;">access denied, login required!</h1>

        <h2 class="form-signin-heading">Prašome prisijungti</h2>
        <label for="inputEmail" class="sr-only">El. pašto adresas</label>
        <input type="email" id="inputEmail" name="email" class="form-control" placeholder="Email address" required autofocus value="myemail@google.com">
